                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input className={inputStyle} type="text" id="prepTime" placeholder="15 min" {...register("prepTime")} />
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input className={inputStyle} type="text" id="cookTime" placeholder="30 min" {...register("cookTime")} />
